...
<div class="card my-3 table-responsive">
    <div class="card-header fw-bold" style="background:#8c19c2;">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                ...
                <form action="actions/add_managers.php" method="POST" enctype="multipart/form-data" lass="p-3">
                    <div class="modal fade" id="addnew" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background:#8c19c2; color: white;">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Add Managers</h5>
    ...
    <table class="table">
        ...
        <tbody>
            <?php
               require_once('partials/i_managers.php');
                ?>
        </tbody>
    </table>
</div>
