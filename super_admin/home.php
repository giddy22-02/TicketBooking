        ...
        <div class="card my-3 table-responsive">
            <div class="card-header fw-bold" style="background:#8c19c2;">
                ...
                {?>
                    ...
                    <div class="col-md-4 text-center">
                        <!-- Modal  For Adding New Candidates-->
                        <form action="actions/add_branch.php" method="POST" enctype="multipart/form-data" lass="p-3">
                            <div class="modal fade" id="addnewb" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background:#8c19c2; color: white;">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control w-80 m-auto" name="yf"
                                                    placeholder="Year of Launch" required="required">
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control w-80 m-auto" name="manager"
                                                    placeholder="Manager's Name" required="required">
                                            </div>
                        ...
                        <!--Add New admins Button-->
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-light my-3" data-toggle="modal" data-target="#addnewb"
                            style="color:#8c19c2">
                            <i class="bi bi-person-plus"></i> Add New
                        </button>
                    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
               require_once('partials/i_branches.php');
                ?>
                </tbody>
            </table>
        </div>
